...
RelativeLayout.SetLeftRelativeOffset(blueRect, 1.0f);
RelativeLayout.SetRightRelativeOffset(blueRect, 1.0f);
RelativeLayout.SetFillHorizontalAlignment()


View greenRect = new View
{
    BackgroundColor = new Color(0.0f, 1.0f, 0.0f, 1.0f),
    HeightSpecification = 100
};

RelativeLayout.SetLeftTarget(greenRect, redRect);
RelativeLayout.SetRightTarget(greenRect, blueRect);
RelativeLayout.SetFillHorizontal(greenRect, true);
RelativeLayout.SetLeftRelativeOffset(greenRect, 1.0f);
...
The alignment property allows to change fixed size view begins position when all while to targets on the same axis (horizontal or vertical) are set to the same value.

|`HorizontalAlignment`: Start |`HorizontalAlignment`: Center|`HorizontalAlignment`: End|
| :---: | :---: | :---: |
| ![RelativeImagePositionBeginsStart](./media/RelativeLayoutAlignPositionBeginStart.png) | ![RelativeImagePositionBeginsStart](./media/RelativeLayoutAlignPositionBeginCenter.png) | ![RelativeImagePositionBeginsStart](./media/RelativeLayoutAlignPositionBeginEnd.png) |
...
<div id="TabSection2">
    <div class="sampletab " id="ProjectCreateTab">
        <button id="RelativeLayout-Init-CSharp" class="tablinks " onclick="openTabSection(event, 'RelativeLayout-Init-CSharp', 'TabSection2') ">C#</button>
        <button id="RelativeLayout-Init-Xaml" class="tablinks " onclick="openTabSection(event, 'RelativeLayout-Init-Xaml', 'TabSection2') ">Xaml</button>
    </div>
