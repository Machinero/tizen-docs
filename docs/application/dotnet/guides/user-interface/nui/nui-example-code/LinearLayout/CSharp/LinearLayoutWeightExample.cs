...
{
    public class LinearLayoutWeightExample : ContentPage
    {
        public LinearLayoutWeightExample()
        {
    ...
    class Program : NUIApplication
    {
        ...
        void Initialize()
        {
            ...
            LinearLayoutWeightExample CellPadding = new LinearLayoutWeightExample();
            Window.Instance.Add(CellPadding);
        }
