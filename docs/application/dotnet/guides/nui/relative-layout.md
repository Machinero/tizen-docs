...
<div id="TabSection1">
    <div class="sampletab " id="ProjectCreateTab">
        <button id="create-button1" class="tablinks " onclick="openTabSection(event, 'RelativeLayout-Targets-Offsets-CSharp', 'TabSection1') ">C#</button>
        <button id="create-button2" class="tablinks " onclick="openTabSection(event, 'RelativeLayout-Targets-Offsets-CSharp', 'TabSection1') ">Xaml</button>
    </div>
